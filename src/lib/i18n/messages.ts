...
const en = {
  ...
  siteTagline: "Character appearances and dialogue, patch by patch",
  siteDescription:
    "Track Wuthering Waves (WuWa) character dialogue line counts across main story, companion, event, and side quests. Compare version stats, story-segment rankings, and per-character word clouds.",
  siteKeywords: [
    "Wuthering Waves",
    "WuWa",
    "鸣潮",
  ...
  characters: {
    title: "Characters",
    description:
      "Find a character to see their dialogue, story appearances, and word cloud.",
  ...
  storySegments: {
    ...
    versionAppearances: "Patch-half appearances",
  ...
  optionalQuests: {
    ...
    sectionDescriptions: {
      companion:
        "Per companion story quest. Appearances and lines from encore.moe dialogue.",
      event:
        "Per event quest storyline. Appearances and lines from encore.moe dialogue.",
...
export const messages: Record<SiteLocale, Messages> = {
  ...
  zh: {
    siteTitle: "鸣潮台词库",
    siteTagline: "按版本查角色出场与台词",
    siteDescription:
      "鸣潮台词库：查询鸣潮角色台词数量、主线剧情登场、伴星/活动/支线台词统计、版本对比与台词词云。",
    siteKeywords: [
      "鸣潮",
      "鸣潮台词",
      "鸣潮台词库",
    ...
    characters: {
      title: "角色",
      description: "找一个角色，看看 TA 的台词、剧情出场和词云。",
    ...
    characterDetail: {
      ...
      storySectionDescription:
        "按主线段落统计。登场依据 Fandom 任务 infobox，若 wiki 未收录但有 encore 台词则计为登场；台词数来自",
      storySegment: "主线段落",
      appeared: "登场",
      lineCount: "台词数",
      ...
      wordCloudTitle: "台词词云",
      wordCloudDescription:
        "汇总该角色在主线、伴星/活动/支线及系统语音中的台词，展示高频词语。",
